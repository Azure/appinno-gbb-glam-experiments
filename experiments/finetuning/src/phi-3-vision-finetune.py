"""
example for finetuning Phi-3-V using the Hugging Face Trainer API
Modified from Phi-3CookBook:
...
def create_dataset(eval_size=500):
    ...
    #     'HuggingFaceM4/the_cauldron', 'hateful_memes', split=f'train[:{eval_size}]'
    # )
    train_dataset = load_from_disk('training-data/training.hf')
    eval_dataset = load_from_disk('training-data/evaluation.hf')
